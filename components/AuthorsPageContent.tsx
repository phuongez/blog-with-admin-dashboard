          ...
          {authors.map((author) => {
            ...
            return (
              <div key={author.id}>
                ...
                {/* Featured Articles */}
                <h1 className="text-xl font-bold mt-6">Bài viết nổi bật</h1>
                <div className="flex overflow-x-scroll overflow-y-hidden py-0 gap-4 pt-4 h-full scrollbar-hide pb-6">
                  {author.articles.slice(0, 5).map((article: any) => (
